// -*- C++ -*-
/**
 * @file    hello_extended_receiver_exec.cpp
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 * Chamber of commerce Rotterdam nr.276339, The Netherlands
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : hello_extended_receiver_impl.cpp[Header]

#include "hello_extended_receiver_exec.h"
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_receiver_impl.cpp[Footer]
