// -*- C++ -*-
/**
 * @file    hello_extended_receiver_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_HELLO_EXTENDED_RECEIVER_EXEC_H_FDJAAHIH_INCLUDED__
#define __RIDL_HELLO_EXTENDED_RECEIVER_EXEC_H_FDJAAHIH_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : hello_extended_receiver_impl.h[Header]

#pragma once

#include "hello_extended_receiverEC.h"

#include /**/ "hello_extended_receiver_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_receiver_impl.h[user_includes]
// Your includes here
//@@{__RIDL_REGEN_MARKER__} - END : hello_extended_receiver_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_receiver_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : hello_extended_receiver_impl.h[user_global_decl]
...
extern "C" HELLO_EXTENDED_RECEIVER_EXEC_Export  void
create_Hello_Receiver_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_receiver_impl.h[Footer]

#endif /* __RIDL_HELLO_EXTENDED_RECEIVER_EXEC_H_FDJAAHIH_INCLUDED__ */
