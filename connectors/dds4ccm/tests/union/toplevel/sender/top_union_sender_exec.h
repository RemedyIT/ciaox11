// -*- C++ -*-
/**
 * @file    top_union_sender_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_TOP_UNION_SENDER_EXEC_H_JJJFCEIG_INCLUDED__
#define __RIDL_TOP_UNION_SENDER_EXEC_H_JJJFCEIG_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : top_union_sender_impl.h[Header]

#pragma once

#include "top_union_senderEC.h"

#include /**/ "sender_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_sender_impl.h[user_includes]
//@@{__RIDL_REGEN_MARKER__} - END : top_union_sender_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_sender_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : top_union_sender_impl.h[user_global_decl]
...
namespace Uni_Sender_Impl
{
  ...
  enum class ASSIGNMENT : uint32_t
  {
    ASSIGNMENT_NONE,
    ASSIGNMENT_TEST_ONE,
    ASSIGNMENT_TEST_SEQ_WITH_D_IS_5,
    ASSIGNMENT_TEST_SEQ_WITH_D_IS_6
  };// ASSIGNMENT
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_sender_impl.h[Footer]

#endif /* __RIDL_TOP_UNION_SENDER_EXEC_H_JJJFCEIG_INCLUDED__ */
