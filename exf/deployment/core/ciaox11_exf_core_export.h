...
#if defined (TAOX11_AS_STATIC_LIBS) && !defined (CIAOX11_EXF_CORE_HAS_DLL)
#  define CIAOX11_EXF_CORE_HAS_DLL 0
#endif /* TAOX11_AS_STATIC_LIBS && CIAOX11_EXF_CORE_HAS_DLL */
...
#    define CIAOX11_EXF_CORE_Export TAOX11_Proper_Export_Flag
#    define CIAOX11_EXF_CORE_SINGLETON_DECLARATION(T) TAOX11_EXPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_CORE_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* CIAOX11_EXF_CORE_BUILD_DLL */
#    define CIAOX11_EXF_CORE_Export TAOX11_Proper_Import_Flag
#    define CIAOX11_EXF_CORE_SINGLETON_DECLARATION(T) TAOX11_IMPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_CORE_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
