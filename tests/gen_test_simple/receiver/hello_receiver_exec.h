...
#ifndef __RIDL_HELLO_RECEIVER_EXEC_H_CAFCJBFA_INCLUDED__
#define __RIDL_HELLO_RECEIVER_EXEC_H_CAFCJBFA_INCLUDED__
...
namespace Hello_Receiver_Impl
{
  ...
  public:
    ...
    void
    test_topic (
        const ::Hello::TestTopic& test_topic) override;
    //@}
...
#endif /* __RIDL_HELLO_RECEIVER_EXEC_H_CAFCJBFA_INCLUDED__ */
