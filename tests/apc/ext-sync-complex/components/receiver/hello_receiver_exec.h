...
namespace Hello_Receiver_Impl
{
  ...
  /// Executor implementation class for do_my_B facet
  class do_my_B_exec_i final
  ...
  private:
    ...
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_B_exec_i[user_members]
    //@}
  ...
  public:
    ...
    /// Factory method and getter for the do_my_B facet
    /// @return existing instance of facet if one exists, else creates one
    virtual IDL::traits< ::Hello::CCM_B >::ref_type get_do_my_B () override;
    //@}
  ...
  private:
    ...
    //@{
    IDL::traits< ::Hello::CCM_B >::ref_type do_my_B_;
    //@}
