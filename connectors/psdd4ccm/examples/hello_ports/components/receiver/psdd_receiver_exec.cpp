...
namespace Test_Receiver_Impl
{
  ...
  /**
   * Facet Executor Implementation Class : hello_sub_data_listener_exec_i
   */

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i[ctor]
  hello_sub_data_listener_exec_i::hello_sub_data_listener_exec_i (
  ...
  hello_sub_data_listener_exec_i::~hello_sub_data_listener_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i[user_private_ops]


  /** Operations and attributes from hello_sub_data_listener */

  void
  hello_sub_data_listener_exec_i::on_data (
      ::Test::StringSeq_t& data)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i::on_data[_data]
    PSDD4CCM_TEST_DEBUG << "hello_sub_data_listener_exec_i::on_data : received [" << IDL::traits< ::Test::StringSeq_t>::write (data) << "]" << std::endl;
    auto cex = IDL::traits<Receiver_exec_i>::narrow (this->component_executor_.lock ());
    if (cex)
    {
      cex->increment_hello_counter ((uint32_t)data.size ());
    }
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i::on_data[_data]
  }

  ::CCM_PSDD::ListenerMode
  hello_sub_data_listener_exec_i::listen_mode ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i::listen_mode[getter]
    return this->listen_mode_;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i::listen_mode[getter]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i::listen_mode[setter]
    this->listen_mode_ = listen_mode;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i::listen_mode[setter]
  }

  ::CCM_PSDD::DataCount_t
  hello_sub_data_listener_exec_i::max_data ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i::max_data[getter]
    return this->max_data_;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i::max_data[getter]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::hello_sub_data_listener_exec_i::max_data[setter]
    this->max_data_ = max_data;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::hello_sub_data_listener_exec_i::max_data[setter]
  }
  /**
   * Facet Executor Implementation Class : msg_sub_data_listener_exec_i
   */

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i[ctor]
  msg_sub_data_listener_exec_i::msg_sub_data_listener_exec_i (
    IDL::traits< ::Test::CCM_Receiver>::weak_ref_type component_executor,
    IDL::traits< ::Test::CCM_Receiver_Context>::ref_type context)
    : context_ (std::move (context))
    , component_executor_ (std::move(component_executor))
  ...
  msg_sub_data_listener_exec_i::~msg_sub_data_listener_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i[user_private_ops]


  /** Operations and attributes from msg_sub_data_listener */

  void
  msg_sub_data_listener_exec_i::on_data (
      ::Test::MessageSeq_t& data)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i::on_data[_data]
    PSDD4CCM_TEST_DEBUG << "msg_sub_data_listener_exec_i::on_data : received [" << IDL::traits< ::Test::MessageSeq_t>::write (data) << "]" << std::endl;
    auto cex = IDL::traits<Receiver_exec_i>::narrow (this->component_executor_.lock ());
    if (cex)
    {
      cex->increment_msg_counter ((uint32_t)data.size ());
    }
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i::on_data[_data]
  }

  ::CCM_PSDD::ListenerMode
  msg_sub_data_listener_exec_i::listen_mode ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i::listen_mode[getter]
    return this->listen_mode_;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i::listen_mode[getter]
  }
  ...
  msg_sub_data_listener_exec_i::listen_mode (
      ::CCM_PSDD::ListenerMode listen_mode)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i::listen_mode[setter]
    this->listen_mode_ = listen_mode;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i::listen_mode[setter]
  }

  ::CCM_PSDD::DataCount_t
  msg_sub_data_listener_exec_i::max_data ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i::max_data[getter]
    return this->max_data_;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i::max_data[getter]
  }
  ...
  msg_sub_data_listener_exec_i::max_data (
      ::CCM_PSDD::DataCount_t max_data)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::msg_sub_data_listener_exec_i::max_data[setter]
    this->max_data_ = max_data;
    //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::msg_sub_data_listener_exec_i::max_data[setter]
  }
    ...
    try
    {
          ...
          && this->count () > this->hello_counter_)
      {
        IDL::traits<Test::Hello::Getter>::ref_type reader =
          this->context_->get_connection_hello_sub_data ();
        std::string topic;
          ...
          && this->count () > this->msg_counter_)
      {
        IDL::traits<Test::Msg::Getter>::ref_type reader =
          this->context_->get_connection_msg_sub_data ();
        ::Test::Message topic;
        if (reader->get_one (topic))
        {
  ...
  void Receiver_exec_i::ccm_activate ()
  {
    ...
    if (this->subscription_.empty ())
    {
      ...
      {
        auto hello_sub = this->context_->get_connection_hello_sub_data_subscriber ();
      ...
      {
        auto msg_sub = this->context_->get_connection_msg_sub_data_subscriber ();
  ...
  Receiver_exec_i::get_hello_sub_data_listener ()
  {
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::Receiver_exec_i[get_hello_sub_data_listener]
    if (!this->hello_sub_data_listener_)
    {
      this->hello_sub_data_listener_ =
          CORBA::make_reference <hello_sub_data_listener_exec_i> (
              IDL::traits<Test::CCM_Receiver>::narrow (this->_lock()),
              this->context_);
    }
    return this->hello_sub_data_listener_;
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::Receiver_exec_i[get_hello_sub_data_listener]
  }

  IDL::traits< ::Test::Msg::CCM_Listener>::ref_type
  Receiver_exec_i::get_msg_sub_data_listener ()
  {
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Test_Receiver_Impl::Receiver_exec_i[get_msg_sub_data_listener]
    if (!this->msg_sub_data_listener_)
    {
      this->msg_sub_data_listener_ =
          CORBA::make_reference <msg_sub_data_listener_exec_i> (
              IDL::traits<Test::CCM_Receiver>::narrow (this->_lock()),
              this->context_);
    }
    return this->msg_sub_data_listener_;
  //@@{__RIDL_REGEN_MARKER__} - END : Test_Receiver_Impl::Receiver_exec_i[get_msg_sub_data_listener]
  }
