...
template <typename CCM_TYPE, typename TOPIC_TYPE, typename TOPIC_SEQ_TYPE>
void
DDS_Update_Port_T<CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE>::configuration_complete_port (
  IDL::traits<::DDS::Topic>::ref_type topic,
  IDL::traits<::DDS::Publisher>::ref_type publisher,
  const std::string &qos_profile)
{
  DDS4CCM_LOG_TRACE ("DDS_Update_Port_T<" << ::DDS::traits<TOPIC_TYPE>::get_type_name() << ">::configuration_complete_port");
...
template <typename CCM_TYPE, typename TOPIC_TYPE, typename TOPIC_SEQ_TYPE>
void
DDS_Update_Port_T<CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE>::remove_port (
  IDL::traits<::DDS::Publisher>::ref_type publisher)
{
  DDS4CCM_LOG_TRACE ("DDS_Update_Port_T<" << ::DDS::traits<TOPIC_TYPE>::get_type_name() << ">::remove_port");
