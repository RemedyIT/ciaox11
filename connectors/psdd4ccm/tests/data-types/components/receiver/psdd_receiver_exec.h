...
namespace Test_Receiver_Impl
{
  ...
  private:
    ...
    void check_datum (const ::Test::Topic& datum);
    void check_b31_array (const std::array< Test::B31, 2 > &to_check, int32_t iter);
    void check_standard_types (const ::Test::Topic& datum);
