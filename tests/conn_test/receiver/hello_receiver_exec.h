 ...
 */
#ifndef __RIDL_HELLO_RECEIVER_EXEC_H_CEFCFDIE_INCLUDED__
#define __RIDL_HELLO_RECEIVER_EXEC_H_CEFCFDIE_INCLUDED__
...
namespace Hello_Receiver_Impl
{
  ...
  private:
    ...
    bool get_rec_listen_port_bar_prov_invoked_ {};
    bool get_rec_listen_port_foo_prov_invoked_ {};
...
#endif /* __RIDL_HELLO_RECEIVER_EXEC_H_CEFCFDIE_INCLUDED__ */
