...
#ifndef __RIDL_HELLO_RECEIVER_EXEC_H_IECDHFDA_INCLUDED__
#define __RIDL_HELLO_RECEIVER_EXEC_H_IECDHFDA_INCLUDED__
...
#endif /* __RIDL_HELLO_RECEIVER_EXEC_H_IECDHFDA_INCLUDED__ */
