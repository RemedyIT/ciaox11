...
namespace Hello_Receiver_Impl
{
  ...
  void Receiver_exec_i::ccm_passivate ()
  {
    ...
    if (foo_port_r_port_attrib() != 111)
    {
      CIAOX11_TEST_ERROR << " ERROR Receiver: expexted attribute values 111 for foo_port_r_port_attrib but received "
                         <<  foo_port_r_port_attrib() << std::endl;
    }
    else  CIAOX11_TEST_INFO << " Receiver: attribute values : "
                         <<  foo_port_r_port_attrib() <<  std::endl;
  ...
  int16_t
  Receiver_exec_i::foo_port_r_port_attrib ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_attrib[getter]
    return this->foo_port_r_port_attrib_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_attrib[getter]
  }

  void
  Receiver_exec_i::foo_port_r_port_attrib (
      int16_t foo_port_r_port_attrib)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_attrib[setter]
    this->foo_port_r_port_attrib_ = foo_port_r_port_attrib;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_attrib[setter]
  }

  ::Hello::long_seq_r
  Receiver_exec_i::foo_port_r_port_seq_attrib ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_seq_attrib[getter]
    return this->foo_port_r_port_seq_attrib_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_seq_attrib[getter]
  }

  void
  Receiver_exec_i::foo_port_r_port_seq_attrib (
      const ::Hello::long_seq_r& foo_port_r_port_seq_attrib)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_seq_attrib[setter]
    this->foo_port_r_port_seq_attrib_ = foo_port_r_port_seq_attrib;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::foo_port_r_port_seq_attrib[setter]
  }

  ::Hello::rec_struct
  Receiver_exec_i::rec_struct_attrib ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::rec_struct_attrib[getter]
    return this->rec_struct_attrib_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::rec_struct_attrib[getter]
  }

  void
  Receiver_exec_i::rec_struct_attrib (
      const ::Hello::rec_struct& rec_struct_attrib)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::rec_struct_attrib[setter]
    this->rec_struct_attrib_ = rec_struct_attrib;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::rec_struct_attrib[setter]
  }
