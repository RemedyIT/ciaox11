...
#ifndef __RIDL_QA_RG_RECEIVER_EXEC_H_BAHEIIIA_INCLUDED__
#define __RIDL_QA_RG_RECEIVER_EXEC_H_BAHEIIIA_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : qa_rg_receiver_impl.h[Header]

#pragma once

#include "qa_rg_receiverEC.h"

#include /**/ "receiver_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_rg_receiver_impl.h[user_includes]
//@@{__RIDL_REGEN_MARKER__} - END : qa_rg_receiver_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_rg_receiver_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : qa_rg_receiver_impl.h[user_global_decl]

/// Namespace for implementation of QA_Read_Get_Test::Receiver component
namespace QA_Read_Get_Test_Receiver_Impl
{
  /// Forward declarations
  class Receiver_exec_i;

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl[user_namespace_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl[user_namespace_decl]
  ...
  private:
    ...
    IDL::traits< ::QA_Read_Get_Test::CCM_Receiver_Context >::ref_type context_;

    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::get_port_status_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl::get_port_status_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::listen_port_data_listener_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl::listen_port_data_listener_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::listen_port_status_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl::listen_port_status_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::start_reading_exec_i[user_members]
    IDL::traits< QA_Read_Get_Test::CCM_Receiver>::weak_ref_type component_executor_;
    //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl::start_reading_exec_i[user_members]
    //@}
  ...
  class Receiver_exec_i final
    : public virtual IDL::traits< ::QA_Read_Get_Test::CCM_Receiver>::base_type
  {
  public:
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::Receiver_exec_i[user_members]
    ...
    bool last_get {};
    bool last_listen {};
    //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl::Receiver_exec_i[user_members]
    //@}

    /** @name User defined private operations. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl::Receiver_exec_i[user_private_ops]
    // Your private operations here
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_Read_Get_Test_Receiver_Impl[user_namespace_end_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : QA_Read_Get_Test_Receiver_Impl[user_namespace_end_decl]
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_rg_receiver_impl.h[Footer]

#endif /* __RIDL_QA_RG_RECEIVER_EXEC_H_BAHEIIIA_INCLUDED__ */
