// -*- C++ -*-
/**
 * @file    extended_hello_receiver_exec.cpp
 * @author  Johnny Willemsen
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : extended_hello_receiver_impl.cpp[Header]

#include "extended_hello_receiver_exec.h"
...
namespace Hello_Receiver_Impl
{
      ...
      std::string& answer)
  {
    ...
    answer += "Hi, " + in_str;
    return "Hi, return from receiver";
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : extended_hello_receiver_impl.cpp[Footer]
