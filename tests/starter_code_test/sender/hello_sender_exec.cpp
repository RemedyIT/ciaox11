...
namespace Hello_Sender_Impl
{
  ...
  int16_t
  Sender_exec_i::ojeetje ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Sender_Impl::Sender_exec_i::ojeetje[getter]
    return this->ojeetje_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Sender_Impl::Sender_exec_i::ojeetje[getter]
  }
  ...
  Sender_exec_i::ojeetje (
      int16_t ojeetje)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Sender_Impl::Sender_exec_i::ojeetje[setter]
    this->ojeetje_ = ojeetje;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Sender_Impl::Sender_exec_i::ojeetje[setter]
  }
