...
#ifndef __RIDL_MESSAGEPS_SVNT_H_HFGJCDAJ_INCLUDED__
#define __RIDL_MESSAGEPS_SVNT_H_HFGJCDAJ_INCLUDED__

#pragma once

#include /**/ "msg_svnt_export.h"
...
namespace Test_Msg_PSDD_Event_Impl
{
  ...
  /**
   * Context implementation class for the ::Test::Msg::CCM_PSDD_Event
   * component.
   */
  class PSDD_Event_Context final
    : public IDL::traits< ::Test::Msg::CCM_PSDD_Event_Context>::base_type
  {
  public:
    /**
    ...
    IDL::traits< ::Test::Msg::Listener>::ref_type get_connection_consumer_data_listener () override;
    //@}
  ...
  private:
    ...
    IDL::traits< ::Test::Msg::Listener>::ref_type consumer_data_listener_{};
    //@}
  ...
  private:
    ...
    */
    ...
    IDL::traits<::Test::Msg::CCM_PSDD_Event>::ref_type component_executor_;
 ...
 * Test_Msg_PSDD_Event_Impl component
...
#endif /* __RIDL_MESSAGEPS_SVNT_H_HFGJCDAJ_INCLUDED__ */
