...
/// Namespace for implementation of HelloT::Sender component
namespace HelloT_Sender_Impl
{
  /// Forward declarations
  class Sender_exec_i;

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : HelloT_Sender_Impl[user_namespace_decl]
  ...
  //@@{__RIDL_REGEN_MARKER__} - END : HelloT_Sender_Impl[user_namespace_decl]


  /// Component Executor Implementation Class : Sender_exec_i
  class Sender_exec_i final
    : public virtual IDL::traits< ::HelloT::CCM_Sender>::base_type
  {
  public:
  ...
  private:
    ...
    IDL::traits< ::HelloT::CCM_Sender_Context>::ref_type context_;
    ...
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : HelloT_Sender_Impl::Sender_exec_i[user_members]
    asynch_foo_generator asynch_foo_gen_;
    synch_foo_generator synch_foo_gen_;
    //@@{__RIDL_REGEN_MARKER__} - END : HelloT_Sender_Impl::Sender_exec_i[user_members]
    //@}
  ...
  class AMI4CCM_MyFooReplyHandler_run_my_foo_i final
    :public IDL::traits< HelloT::AMI4CCM_MyFooReplyHandler>::base_type
  {
  public:
  ...
  private:
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : HelloT_Sender_Impl::AMI4CCM_MyFooReplyHandler_run_my_foo_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : HelloT_Sender_Impl::AMI4CCM_MyFooReplyHandler_run_my_foo_i[user_members]
    //@}
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : HelloT_Sender_Impl[user_namespace_end_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : HelloT_Sender_Impl[user_namespace_end_decl]
...
#endif /* __RIDL_HELLO_SENDER_EXEC_H_FCACDGGJ_INCLUDED__ */
