 ...
 *
 * @brief   header of sender component implementation
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */

#ifndef __RIDL_HELLO_SENDER_COMP_EXEC_H_HDFHHEEB_INCLUDED__
#define __RIDL_HELLO_SENDER_COMP_EXEC_H_HDFHHEEB_INCLUDED__
...
namespace Hello_Sender_comp_Impl
{
  ...
  public:
    ...
    void set_context(IDL::traits<Hello::CCM_Sender_comp_Context>::ref_type context);
    int svc () override;
...
#endif /* __RIDL_HELLO_SENDER_COMP_EXEC_H_HDFHHEEB_INCLUDED__ */
