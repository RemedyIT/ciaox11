...
In this test logging macro's of CIAX11 and the base X11 are used.

Different settings of the priority masks and verbosity masks of CIAX11_LOGGER are used
