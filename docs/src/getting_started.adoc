...
On the Remedy IT https://www.axcioma.com/documents/presentations.html[AXCIOMA]
...
the https://www.axcioma.com/documents/presentations.html[AXCIOMA] website. There
you can also find a comparison between the IDL to {cpp} and IDL to {cxx11}
language mapping. +
 +
 Remedy IT also offers a
https://www.axcioma.com/services/training.html[Component Based Development using AXCIOMA] course.
