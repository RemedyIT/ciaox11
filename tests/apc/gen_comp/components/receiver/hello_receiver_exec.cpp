...
namespace Hello_Receiver_Impl
{
      ...
      int32_t& answer)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_exec_i::hello[_answer]
     CIAOX11_TEST_INFO << "Receiver hello" << std::endl;
     answer = 10;
  ...
  /**
   * Facet Executor Implementation Class : do_my_foo_2_exec_i
   */
  ...
  do_my_foo_2_exec_i::~do_my_foo_2_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i[dtor]
  }
  ...
  /** Operations and attributes from do_my_foo_2 */

  int32_t
  do_my_foo_2_exec_i::foo (
      const std::string& in_str,
      std::string& answer)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i::foo[_in_str_answer]
    X11_UNUSED_ARG(in_str);
    X11_UNUSED_ARG(answer);
    return {};
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i::foo[_in_str_answer]
  }

  void
  do_my_foo_2_exec_i::hello (
      int32_t& answer)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i::hello[_answer]
    X11_UNUSED_ARG(answer);
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i::hello[_answer]
  }

  int16_t
  do_my_foo_2_exec_i::rw_attrib ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i::rw_attrib[getter]
    return this->rw_attrib_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i::rw_attrib[getter]
  }
  ...
  do_my_foo_2_exec_i::rw_attrib (
      int16_t rw_attrib)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i::rw_attrib[setter]
    this->rw_attrib_ = rw_attrib;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i::rw_attrib[setter]
  }

  int16_t
  do_my_foo_2_exec_i::ro_attrib ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_2_exec_i::ro_attrib[getter]
    return this->ro_attrib_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_2_exec_i::ro_attrib[getter]
  }
  /**
   * Facet Executor Implementation Class : do_my_foo_in_bar_exec_i
   */
  ...
  do_my_foo_in_bar_exec_i::~do_my_foo_in_bar_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_in_bar_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_in_bar_exec_i[dtor]
  }
  ...
  /** Operations and attributes from do_my_foo_in_bar */

  uint16_t
  do_my_foo_in_bar_exec_i::hello ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo_in_bar_exec_i::hello[void]
    return {};
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo_in_bar_exec_i::hello[void]
  }
  ...
  {
    CIAOX11_TEST_INFO << "Receiver ACTIVATE" << std::endl;
  }
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i[get_do_my_foo_2]
    if (!this->do_my_foo_2_)
    {
      this->do_my_foo_2_ = CORBA::make_reference <do_my_foo_2_exec_i> (this->context_);
    }
    return this->do_my_foo_2_;
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i[get_do_my_foo_in_bar]
    if (!this->do_my_foo_in_bar_)
    {
      this->do_my_foo_in_bar_ = CORBA::make_reference <do_my_foo_in_bar_exec_i> (this->context_);
    }
    return this->do_my_foo_in_bar_;
  //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i[get_do_my_foo_in_bar]
  }


  ::Foo::Bar_in_Bar
  Receiver_exec_i::my_rec_attrib_bar ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::Receiver_exec_i::my_rec_attrib_bar[getter]
    return this->my_rec_attrib_bar_;
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::Receiver_exec_i::my_rec_attrib_bar[getter]
  }
