...
#ifndef __RIDL_HELLO_SENDER_EXEC_H_IIAJBDFH_INCLUDED__
#define __RIDL_HELLO_SENDER_EXEC_H_IIAJBDFH_INCLUDED__
...
namespace Test_Sender_Impl
{
  ...
  class hello_generator : public ACE_Task_Base
   {
   public:
     hello_generator ();
   ...
   private:
     IDL::traits<Test::CCM_Sender_Context>::ref_type ciao_context_;
     bool errors_ {};
   };
...
#endif /* __RIDL_HELLO_SENDER_EXEC_H_IIAJBDFH_INCLUDED__ */
