...
$plan_file = "../descriptors/plan." . $plan_fmt;
...
print "Invoking domain deployment manager (dancex11_deployment_manager.exe --handler dancex11_domain_dm_handler) with -l $plan_file\n";
$EM = $tg_exe_man->CreateProcess ("$DANCEX11_ROOT/$DANCEX11_BIN_FOLDER/dancex11_deployment_manager",
                                    "--handler dancex11_domain_dm_handler -l " .
                                    $tg_exe_man->LocalFile($plan_file) .
