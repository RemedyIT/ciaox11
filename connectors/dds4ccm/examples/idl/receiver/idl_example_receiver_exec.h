// -*- C++ -*-
/**
 * @file    idl_example_receiver_exec.h
 * @author  Marcel Smit
 *
...
#ifndef __RIDL_IDL_EXAMPLE_RECEIVER_EXEC_H_IAIGDCCD_INCLUDED__
#define __RIDL_IDL_EXAMPLE_RECEIVER_EXEC_H_IAIGDCCD_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : idl_example_receiver_impl.h[Header]

#pragma once

#include "idl_example_receiverEC.h"

#include /**/ "receiver_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : idl_example_receiver_impl.h[user_includes]
#include <atomic>
//@@{__RIDL_REGEN_MARKER__} - END : idl_example_receiver_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : idl_example_receiver_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : idl_example_receiver_impl.h[user_global_decl]
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : idl_example_receiver_impl.h[Footer]

#endif /* __RIDL_IDL_EXAMPLE_RECEIVER_EXEC_H_HFIBBGAA_INCLUDED__ */
