...
namespace Test_Hello_PSDD_Event_Impl
{
  ...
  IDL::traits<Test::Hello::Listener>::ref_type
    ...
    const ::Components::ConfigValues& config)
  {
    ...
    {
      this->consumer_data_listener_ = IDL::traits<Test::Hello::Listener>::narrow (std::move(connection));
...
{
  IDL::traits< ::Test::Hello::CCM_PSDD_Event>::ref_type component_executor =
    IDL::traits< ::Test::Hello::CCM_PSDD_Event>::narrow (std::move(p));

  if (component_executor)
  {
    // Create the context for this component, passing in it's ServiceRegistry
    IDL::traits<Test_Hello_PSDD_Event_Impl::PSDD_Event_Context>::ref_type context =
      CORBA::make_reference<Test_Hello_PSDD_Event_Impl::PSDD_Event_Context> (std::move(svcreg), ins_name);
    ...
    executor_locator =
      CORBA::make_reference <Test_Hello_PSDD_Event_Impl::PSDD_Event_ExecutorLocator> (
