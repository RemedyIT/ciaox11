...
#if defined (ACE_AS_STATIC_LIBS) && !defined (CIAOX11_EXF_HANDLER_HAS_DLL)
#  define CIAOX11_EXF_HANDLER_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && CIAOX11_EXF_HANDLER_HAS_DLL */
...
#    define CIAOX11_EXF_HANDLER_Export ACE_Proper_Export_Flag
#    define CIAOX11_EXF_HANDLER_SINGLETON_DECLARATION(T) ACE_EXPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_HANDLER_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* CIAOX11_EXF_HANDLER_BUILD_DLL */
#    define CIAOX11_EXF_HANDLER_Export ACE_Proper_Import_Flag
#    define CIAOX11_EXF_HANDLER_SINGLETON_DECLARATION(T) ACE_IMPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_HANDLER_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
