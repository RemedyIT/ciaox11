// -*- C++ -*-
/**
 * @file    fa_el_receiver_exec.cpp
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : fa_el_receiver_impl.cpp[Header]

#include "fa_el_receiver_exec.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl[user_includes]
...
//@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl[user_global_impl]
//@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl[user_global_impl]

namespace FA_Event_Listen_Test_Receiver_Impl
{
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl[user_namespace_impl]
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl[user_namespace_impl]
  ...
  listen_port_1_data_listener_exec_i::~listen_port_1_data_listener_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_private_ops]
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i::on_one_data[_datum_info]
    X11_UNUSED_ARG(info);
    ++this->received_;
    check_sample (datum);
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i::on_one_data[_datum_info]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i::on_many_data[_data_infos]
    X11_UNUSED_ARG(data);
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i::on_many_data[_data_infos]
  }
  /**
  ...
  listen_port_1_status_exec_i::~listen_port_1_status_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_private_ops]
      ...
      const ::DDS::RequestedDeadlineMissedStatus& status)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i::on_requested_deadline_missed[_the_reader_status]
  }
      ...
      const ::DDS::SampleLostStatus& status)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i::on_sample_lost[_the_reader_status]
  }
  /**
  ...
  listen_port_2_data_listener_exec_i::~listen_port_2_data_listener_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_private_ops]
  ...
  listen_port_2_data_listener_exec_i::on_one_data (
      ...
      const ::CCM_DDS::ReadInfo& info)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i::on_one_data[_datum_info]
    X11_UNUSED_ARG(datum);
    X11_UNUSED_ARG(info);
    DDS4CCM_TEST_ERROR << "ERROR: listen_port_2_data_listener_exec_i::on_one_data - "
      << "Unexpected invocation." << std::endl;
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i::on_one_data[_datum_info]
  }
  ...
  listen_port_2_data_listener_exec_i::on_many_data (
      ...
      const ::CCM_DDS::ReadInfoSeq& infos)
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i::on_many_data[_data_infos]
    X11_UNUSED_ARG(infos);
    this->received_ += data.size ();
    check_samples (data);
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i::on_many_data[_data_infos]
  }
  /**
  ...
  listen_port_2_status_exec_i::~listen_port_2_status_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_private_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_private_ops]
      ...
      const ::DDS::RequestedDeadlineMissedStatus& status)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i::on_requested_deadline_missed[_the_reader_status]
  }
      ...
      const ::DDS::SampleLostStatus& status)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i::on_sample_lost[_the_reader_status]
  }

  /**
   * Component Executor Implementation Class : Receiver_exec_i
   */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ctor]
  ...
  Receiver_exec_i::~Receiver_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[dtor]
  }

  /** User defined public operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[user_public_ops]
  // Your code here
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[user_public_ops]

  /** User defined private operations. */
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[user_private_ops]
  void
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[configuration_complete]
    DDS4CCM_TEST_DEBUG << "Receiver_exec_i::configuration_complete" << std::endl;
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[configuration_complete]
  }

  void Receiver_exec_i::ccm_activate ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ccm_activate]
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ccm_activate]
  }

  void Receiver_exec_i::ccm_passivate ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ccm_passivate]
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ccm_passivate]
  }

  void Receiver_exec_i::ccm_remove ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[ccm_remove]
    // Your code here
  ...
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[get_listen_port_2_status]
  }
    ...
    IDL::traits<Components::SessionContext>::ref_type ctx)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[set_session_context]
    this->context_ = IDL::traits<FA_Event_Listen_Test::CCM_Receiver_Context>::narrow (std::move(ctx));
    //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i[set_session_context]
  }


  //@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl[user_namespace_end_impl]
  //@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl[user_namespace_end_impl]

} // namespace FA_Event_Listen_Test_Receiver_Impl

//@@{__RIDL_REGEN_MARKER__} - BEGIN : FA_Event_Listen_Test_Receiver_Impl[factory]
extern "C" void
create_FA_Event_Listen_Test_Receiver_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component)
{
  component = CORBA::make_reference <FA_Event_Listen_Test_Receiver_Impl::Receiver_exec_i> ();
}
//@@{__RIDL_REGEN_MARKER__} - END : FA_Event_Listen_Test_Receiver_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : fa_el_receiver_impl.cpp[Footer]
