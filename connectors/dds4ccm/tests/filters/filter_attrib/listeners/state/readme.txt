...
The parameters and queries are configured in the deployment plan. The query
cannot be changed; the query parameters can.
...
The InternalError exception and the NonChangeable exception will be also be tested.
