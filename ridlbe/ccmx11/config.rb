      ...
      ol.for_switch '-W<extended option>=OPT', :type => String, :separator => true do |swcfg|
        swcfg.modify_group :b_extopt do |grpcfg|
          grpcfg.modify_params :strings,
            :params => {
              'exec_export_macro' => {:description => "-Wb,exec_export_macro=MACRO\tsets export macro for executor files"},
              'exec_export_include' => {:description => "-Wb,exec_export_include=FILE\tsets export include file for executor files"},
              'exec_export_file' => {:description => "-Wb,exec_export_file=FILE\t\tsets skeleton export file to generate for -Gxhex"},
              'conn_export_macro' => {:description => "-Wb,conn_export_macro=MACRO\tsets export macro for connector files"},
              'conn_export_include' => {:description => "-Wb,conn_export_include=FILE\tsets export include file for connector files"},
              'conn_export_file' => {:description => "-Wb,conn_export_file=FILE\t\tsets connector export file to generate for -Gxhcn"},
              'svnt_export_macro' => {:description => "-Wb,svnt_export_macro=MACRO\tsets export macro for servant files"},
              'svnt_export_include' => {:description => "-Wb,svnt_export_include=FILE\tsets export include file for servant files"},
              'svnt_export_file' => {:description => "-Wb,svnt_export_file=FILE\t\tsets servant export file to generate for -Ghst"},
              'lem_stub_export_macro' => {:description => "-Wb,lem_stub_export_macro=MACRO\tsets export macro for lem stub files"},
              'lem_stub_export_include' => {:description => "-Wb,lem_stub_export_include=FILE\tsets export include file for lem stub files"},
              'lem_stub_export_file' => {:description => "-Wb,lem_stub_export_file=FILE\tsets lem stub export file to generate for -Gxhlst"}
            }
        end
      end
        ...
        swcfg.modify_group :gen_flags,
          :params => {
            ...
            'comp' => { :option_name => :gen_comp_complete,
                     :description => "-Gcomp\t\t\tGeneration of all files needed for an user component" },
        ...
        swcfg.for_group :lem_group do |grpcfg|
              ...
              :params => {
                ...
                'gen'  => { :option_name => :gen_lem_gen,
                        :description => "-Glem,gen\t\t\tGeneration of all files needed for the CCM local executor mapping" },
              }
        end
      end
