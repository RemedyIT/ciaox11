// -*- C++ -*-
/**
 * @file    hello_extended_sender_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_HELLO_EXTENDED_SENDER_EXEC_H_GBBABDBE_INCLUDED__
#define __RIDL_HELLO_EXTENDED_SENDER_EXEC_H_GBBABDBE_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : hello_extended_sender_impl.h[Header]

#pragma once

#include "hello_extended_senderEC.h"

#include /**/ "hello_extended_sender_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_sender_impl.h[user_includes]
#include "ace/Task.h"
//@@{__RIDL_REGEN_MARKER__} - END : hello_extended_sender_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_sender_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : hello_extended_sender_impl.h[user_global_decl]

#include "hello_extendedAC.h"
...
extern "C" HELLO_EXTENDED_SENDER_EXEC_Export  void
create_Hello_Sender_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_Sender_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_sender_impl.h[Footer]

#endif /* __RIDL_HELLO_EXTENDED_SENDER_EXEC_H_GBBABDBE_INCLUDED__ */
