// -*- C++ -*-
/**
 * @file    top_union_receiver_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_TOP_UNION_RECEIVER_EXEC_H_HGGFEFHA_INCLUDED__
#define __RIDL_TOP_UNION_RECEIVER_EXEC_H_HGGFEFHA_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : top_union_receiver_impl.h[Header]

#pragma once

#include "top_union_receiverEC.h"

#include /**/ "receiver_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_receiver_impl.h[user_includes]
// Your includes here
//@@{__RIDL_REGEN_MARKER__} - END : top_union_receiver_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_receiver_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : top_union_receiver_impl.h[user_global_decl]
...
namespace Uni_Receiver_Impl
{
  ...
  class info_out_data_listener_exec_i final
    : public IDL::traits< ::Uni::TopUnionConnector::CCM_Listener>::base_type
  {
  public:
  ...
  Receiver_exec_i ();
    ...
    virtual IDL::traits< ::Uni::TopUnionConnector::CCM_Listener>::ref_type get_info_out_data_listener () override;
  ...
  private:
    ...
    //@{
    IDL::traits< ::Uni::TopUnionConnector::CCM_Listener>::ref_type info_out_data_listener_;
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : top_union_receiver_impl.h[Footer]

#endif /* __RIDL_TOP_UNION_RECEIVER_EXEC_H_HGGFEFHA_INCLUDED__ */
