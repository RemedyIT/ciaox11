// -*- C++ -*-
/**
 * @file    hello_extended_sender_exec.cpp
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : hello_extended_sender_impl.cpp[Header]

#include "hello_extended_sender_exec.h"
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_extended_sender_impl.cpp[Footer]
