// -*- C++ -*-
/**
 * @file    filters_common_sl_sender_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_FILTERS_COMMON_SL_SENDER_EXEC_H_CAIFFBJF_INCLUDED__
#define __RIDL_FILTERS_COMMON_SL_SENDER_EXEC_H_CAIFFBJF_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : filters_common_sl_sender_impl.h[Header]

#pragma once

#include "filters_common_sl_senderEC.h"

#include /**/ "sender_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : filters_common_sl_sender_impl.h[user_includes]
//@@{__RIDL_REGEN_MARKER__} - END : filters_common_sl_sender_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : filters_common_sl_sender_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : filters_common_sl_sender_impl.h[user_global_decl]

/// Namespace for implementation of Filters_Common_State_Listen_Test::Sender component
namespace Filters_Common_State_Listen_Test_Sender_Impl
{
  /// Forward declarations
  class Sender_exec_i;

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Filters_Common_State_Listen_Test_Sender_Impl[user_namespace_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : Filters_Common_State_Listen_Test_Sender_Impl[user_namespace_decl]
  ...
  private:
    ...
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Filters_Common_State_Listen_Test_Sender_Impl::connector_status_exec_i[user_members]
    IDL::traits<Filters_Common_State_Listen_Test::CCM_Sender>::weak_ref_type component_executor_;
    bool started_ { false };
    //@@{__RIDL_REGEN_MARKER__} - END : Filters_Common_State_Listen_Test_Sender_Impl::connector_status_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Filters_Common_State_Listen_Test_Sender_Impl::start_writing_exec_i[user_members]
    IDL::traits<Filters_Common_State_Listen_Test::CCM_Sender>::weak_ref_type component_executor_;
    //@@{__RIDL_REGEN_MARKER__} - END : Filters_Common_State_Listen_Test_Sender_Impl::start_writing_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Filters_Common_State_Listen_Test_Sender_Impl::Sender_exec_i[user_members]
    //long ticker_id_ { -1 };
    ...
    CommonTestMessageSeq samples_ {};

    uint16_t last_key_ { 1 };
    uint16_t last_iteration_ { 1 };
    uint16_t last_loop_ { 0 };

    //@@{__RIDL_REGEN_MARKER__} - END : Filters_Common_State_Listen_Test_Sender_Impl::Sender_exec_i[user_members]
    //@}
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : Filters_Common_State_Listen_Test_Sender_Impl[user_namespace_end_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : Filters_Common_State_Listen_Test_Sender_Impl[user_namespace_end_decl]
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : filters_common_sl_sender_impl.h[Footer]

#endif /* __RIDL_FILTERS_COMMON_SL_SENDER_EXEC_H_CAIFFBJF_INCLUDED__ */
