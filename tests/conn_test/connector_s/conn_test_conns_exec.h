...
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : conn_test_conns_impl.h[Header]

#pragma once

#include "conn_test_connsEC.h"

#include /**/ "conn_test_conns_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : conn_test_conns_impl.h[user_includes]
// Your includes here
//@@{__RIDL_REGEN_MARKER__} - END : conn_test_conns_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : conn_test_conns_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : conn_test_conns_impl.h[user_global_decl]
...
extern "C" CONN_TEST_CONNS_EXEC_Export  void
create_Hello_MyBaseEvent_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_MyBaseEvent_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : conn_test_conns_impl.h[Footer]

#endif /* __RIDL_CONN_TEST_CONNS_EXEC_H_IDDJCABE_INCLUDED__ */
