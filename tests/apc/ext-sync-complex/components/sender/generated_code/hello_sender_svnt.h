...
#ifndef __RIDL_HELLO_SENDER_SVNT_H_HFFFGJBF_INCLUDED__
#define __RIDL_HELLO_SENDER_SVNT_H_HFFFGJBF_INCLUDED__

#pragma once

#include /**/ "hello_sender_svnt_export.h"
...
namespace Hello_Sender_Impl
{
  ...
  /**
   * Context implementation class for the ::Hello::CCM_Sender
   * component.
   */
  class Sender_Context final
    : public IDL::traits< ::Hello::CCM_Sender_Context>::base_type
  {
  public:
    /**
    ...
    //@{
    /// Get the run_my_B receptacle
    IDL::traits< ::Hello::B>::ref_type get_connection_run_my_B () override;
    //@}
  ...
  private:
    ...
    //@{
    /// Member variable for storing a reference for the run_my_B receptacle
    IDL::traits< ::Hello::B>::ref_type run_my_B_{};
    //@}
  ...
  private:
    ...
    IDL::traits<::Hello::CCM_Sender>::ref_type component_executor_;
 ...
 */
extern "C" HELLO_SENDER_SVNT_Export  void
...
#endif /* __RIDL_HELLO_SENDER_SVNT_H_HFFFGJBF_INCLUDED__ */
