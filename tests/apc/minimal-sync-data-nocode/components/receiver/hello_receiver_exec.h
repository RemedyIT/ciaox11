 ...
 */
#ifndef __RIDL_HELLO_RECEIVER_EXEC_H_JFJIJCII_INCLUDED__
#define __RIDL_HELLO_RECEIVER_EXEC_H_JFJIJCII_INCLUDED__
...
#endif /* __RIDL_HELLO_RECEIVER_EXEC_H_JFJIJCII_INCLUDED__ */
