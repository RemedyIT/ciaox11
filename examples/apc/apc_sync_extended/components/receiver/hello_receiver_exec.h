...
#include /**/ "my_export_receiver_exec_export.h"
...
namespace Hello_Receiver_Impl
{
  ...
  public:
    ...
    void do_report () { this->control_->report (); }
  ...
  private:
    ...
    IDL::traits<Hello::StateController>::ref_type control_ {};
...
extern "C" MY_EXPORT_RECEIVER_EXEC_Export  void
