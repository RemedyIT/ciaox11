  ...
  const std::string &qos_profile)
{
  ...
  if (!this->data_writer_ && (this->dds4ccm_updater_ || this->ccm_data_writer_))
  {
    ...
    {
      DDS4CCM_LOG_DEBUG ("DDS_Update_Port_T::configuration_complete - "
        << "Created datawriter <"
  ...
  IDL::traits< ::DDS::Publisher>::ref_type publisher)
{
  ...
  if (this->data_writer_)
  {
    DDS4CCM_LOG_DEBUG ("DDS_Update_Port_T::remove - "
    ...
    {
      DDS4CCM_LOG_DEBUG ("DDS_Update_Port_T::remove - deleted DataWriter.");
    }
