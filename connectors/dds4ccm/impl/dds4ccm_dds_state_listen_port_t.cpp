...
template <typename CCM_TYPE, typename TOPIC_TYPE, typename TOPIC_SEQ_TYPE, CIAOX11::DDS4CCM::DDS4CCM_LISTENER_READ_TAKE LRT>
void
DDS_State_Listen_Port_T<CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE, LRT>::activate_listen_port (
...
{
  DDS4CCM_LOG_TRACE ("DDS_State_Listen_Port_T<" << ::DDS::traits<TOPIC_TYPE>::get_type_name() << ">::activate_listen_port");
    ...
    if (dr)
    {
      ...
      if (retcode != ::DDS::RETCODE_OK)
      {
        DDS4CCM_LOG_ERROR ("DDS_State_Listen_Port_T<"
          ...
          << ">::activate_listen_port - Error while setting the listener on the State listener - <"
