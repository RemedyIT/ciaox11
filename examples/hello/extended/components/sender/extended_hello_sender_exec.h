// -*- C++ -*-
/**
 * @file    extended_hello_sender_exec.h
 * @author  Johnny Willemsen
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_EXTENDED_HELLO_SENDER_EXEC_H_GHDHBAAJ_INCLUDED__
#define __RIDL_EXTENDED_HELLO_SENDER_EXEC_H_GHDHBAAJ_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : extended_hello_sender_impl.h[Header]

#pragma once

#include "extended_hello_senderEC.h"

#include /**/ "extended_hello_sender_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : extended_hello_sender_impl.h[user_includes]
#include "ace/Task.h"
//@@{__RIDL_REGEN_MARKER__} - END : extended_hello_sender_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : extended_hello_sender_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : extended_hello_sender_impl.h[user_global_decl]
...
namespace Hello_Sender_Impl
{
  ...
  class foo_generator final : public ACE_Task_Base
  {
  public:
...
extern "C" EXTENDED_HELLO_SENDER_EXEC_Export  void
create_Hello_Sender_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_Sender_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : extended_hello_sender_impl.h[Footer]

#endif /* __RIDL_EXTENDED_HELLO_SENDER_EXEC_H_GHDHBAAJ_INCLUDED__ */
