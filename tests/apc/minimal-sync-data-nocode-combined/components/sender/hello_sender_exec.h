 ...
 */
#ifndef __RIDL_HELLO_SENDER_EXEC_H_IBGDBAGC_INCLUDED__
#define __RIDL_HELLO_SENDER_EXEC_H_IBGDBAGC_INCLUDED__
...
#endif /* __RIDL_HELLO_SENDER_EXEC_H_IBGDBAGC_INCLUDED__ */
