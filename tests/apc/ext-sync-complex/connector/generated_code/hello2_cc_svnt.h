...
#ifndef __RIDL_HELLO2_CC_SVNT_H_HIHCGFCF_INCLUDED__
#define __RIDL_HELLO2_CC_SVNT_H_HIHCGFCF_INCLUDED__

#pragma once

#include /**/ "hello_corba_cc_svnt_export.h"
...
// generated from ccmx11/templates/svnt/hdr/corba/exf/component
namespace Hello_B_SRR_CORBA_Connector_Impl
{

  /**
   * Context implementation class for the ::Hello_B_SRR::CCM_CORBA_Connector
   * component.
   */
  class CORBA_Connector_Context final
    : public IDL::traits< ::Hello_B_SRR::CCM_CORBA_Connector_Context>::base_type
  {
  public:
    /**
     ...
     */
    CORBA_Connector_Context (IDL::traits<CIAOX11::Service_Registry>::ref_type svcreg, std::string ins_name);

    /// Destructor
    ~CORBA_Connector_Context () override = default;
    ...
    //@{
    /// Get the srr_receptacle receptacle
    IDL::traits< ::Hello::B>::ref_type get_connection_srr_receptacle () override;
    //@}
    // generated from ccmx11/templates/svnt/hdr/corba/exf/connector_context_extra_receptacles

    /// @name Configuration accessors for all receptacles
    //@{
    /// Get the srr_receptacle receptacle configuration
    ::Components::ConfigValues srr_receptacle_configuration () override;
    //@}

    friend class CORBA_Connector_ExecutorLocator;
  ...
  private:
    ...
    // generated from exf4cc/templates/svnt/hdr/corba/exf/context_set_connection
    /// Connect method to set the connection for receptacle with name @a name.
    /// In case of multiplex receptacle uses the unique connection name
    /// @a conn_name as cookie.
    bool set_connection (const std::string& name,
                         IDL::traits<CORBA::Object>::ref_type port,
                         const ::Components::ConfigValues& config);

    // generated from ccmx11/templates/svnt/hdr/corba/exf/context_reset_connection
    ...
    //@{
    /// Member variable for storing a reference for the srr_receptacle receptacle
    IDL::traits< ::Hello::B>::ref_type srr_receptacle_{};
    //@}

    // generated from exf4cc/templates/svnt/hdr/corba/exf/context_extra_members

    /// @name Member variables for storing all receptacle configurations
    //@{
    /// Member variable for the srr_receptacle receptacle configuration
    ::Components::ConfigValues srr_receptacle_config_;
    //@}

    //@{
    /** Illegal to be called. Deleted explicitly to let the compiler detect any violation */
    CORBA_Connector_Context () = delete;
    CORBA_Connector_Context (const CORBA_Connector_Context&) = delete;
    CORBA_Connector_Context (CORBA_Connector_Context&&) = delete;
    CORBA_Connector_Context& operator= (const CORBA_Connector_Context&) = delete;
    CORBA_Connector_Context& operator= (CORBA_Connector_Context&&) = delete;
    //@}
  };

  /**
   * ExecutorLocator for the CORBA_Connector component. This
   * gives access to all middleware generated pieces that are used
   * by the CCM infrastructure
   */
  class CORBA_Connector_ExecutorLocator final
  ...
  public:
    ...
    */
    CORBA_Connector_ExecutorLocator (
    ...
    /// Destructor
    ~CORBA_Connector_ExecutorLocator () override = default;
  ...
  private:
    ...
    IDL::traits<::Hello_B_SRR::CCM_CORBA_Connector>::ref_type component_executor_;

    /// The context for this component
    IDL::traits<CORBA_Connector_Context>::ref_type component_context_;

    /** @name Illegal to be called. Deleted explicitly to let the compiler detect any violation */
    //@{
    CORBA_Connector_ExecutorLocator () = delete;
    CORBA_Connector_ExecutorLocator (const CORBA_Connector_ExecutorLocator&) = delete;
    CORBA_Connector_ExecutorLocator (CORBA_Connector_ExecutorLocator&&) = delete;
    CORBA_Connector_ExecutorLocator& operator= (const CORBA_Connector_ExecutorLocator&) = delete;
    CORBA_Connector_ExecutorLocator& operator= (CORBA_Connector_ExecutorLocator&&) = delete;
    //@}
  };
} // namespace Hello_B_SRR_CORBA_Connector_Impl
 ...
 * Hello_B_SRR_CORBA_Connector_Impl component
 ...
 */
extern "C" HELLO_CORBA_CC_SVNT_Export  void
...
#endif /* __RIDL_HELLO2_CC_SVNT_H_HIHCGFCF_INCLUDED__ */
