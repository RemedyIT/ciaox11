...
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : starter_component_impl.h[Header]

#pragma once

#include "starter_componentEC.h"

#include /**/ "starter_component_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : starter_component_impl.h[user_includes]
// Your includes here
//@@{__RIDL_REGEN_MARKER__} - END : starter_component_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : starter_component_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : starter_component_impl.h[user_global_decl]
...
namespace Hello_Receiver_Impl
{
  ...
  /// Executor implementation class for do_foo_bar_bar facet
  class do_foo_bar_bar_exec_i final
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_foo_bar_bar_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_foo_bar_bar_exec_i[user_members]
    //@}
  ...
  public:
    ...
    /// @return existing instance of facet if one exists, else creates one
    IDL::traits<::Hello::CCM_MyBar>::ref_type get_do_foo_bar_bar () override;
    //@}
...
extern "C" STARTER_COMPONENT_EXEC_Export  void
create_Hello_Receiver_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : starter_component_impl.h[Footer]

#endif /* __RIDL_STARTER_COMPONENT_EXEC_H_BJGCJJAG_INCLUDED__ */
