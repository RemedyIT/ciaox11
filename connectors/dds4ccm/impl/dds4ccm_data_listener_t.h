...
namespace CIAOX11
{
  namespace DDS4CCM
  {
     ...
     */
    template <typename CCM_TYPE, typename TOPIC_TYPE, typename TOPIC_SEQ_TYPE>
    class DataReaderListener_T <CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE, CIAOX11::DDS4CCM::DDS4CCM_TAKE> final
     ...
     */
    template <typename CCM_TYPE, typename TOPIC_TYPE, typename TOPIC_SEQ_TYPE>
    class DataReaderListener_T <CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE, CIAOX11::DDS4CCM::DDS4CCM_READ> final
      : public DataReaderListenerBase_T <CCM_TYPE, TOPIC_TYPE, TOPIC_SEQ_TYPE>
    {
    public:
      /// Constructor
