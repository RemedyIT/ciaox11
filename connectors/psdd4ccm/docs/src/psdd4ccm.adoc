...
little effort.
Since PSDD4CCM and DDS4CCM both use IDL defined types, data can be simply
...
A PSDD4CMM connector defined and implemented in this way will provide interfaces
