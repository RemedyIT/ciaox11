// -*- C++ -*-
/**
 * @file    idl_example_receiver_exec.cpp
 * @author  Marcel Smit
 *
 ...
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : idl_example_receiver_impl.cpp[Header]

#include "idl_example_receiver_exec.h"
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : idl_example_receiver_impl.cpp[Footer]
