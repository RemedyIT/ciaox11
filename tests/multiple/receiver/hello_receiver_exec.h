...
#define __RIDL_HELLO_RECEIVER_EXEC_H_CJHABJHB_INCLUDED__
...
namespace Hello_Receiver_Impl
{
  ...
  /// Executor implementation class for do_my_foo2 facet
  class do_my_foo2_exec_i final
    : public IDL::traits<::Hello::CCM_MyFoo>::base_type
  {
  public:
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo2_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo2_exec_i[user_members]
    //@}
  ...
  /// Executor implementation class for do_my_foo3 facet
  class do_my_foo3_exec_i final
    : public IDL::traits<::Hello2::CCM_MyFoo>::base_type
  {
  public:
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : Hello_Receiver_Impl::do_my_foo3_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : Hello_Receiver_Impl::do_my_foo3_exec_i[user_members]
    //@}
...
#endif /* __RIDL_HELLO_RECEIVER_EXEC_H_CJHABJHB_INCLUDED__ */
