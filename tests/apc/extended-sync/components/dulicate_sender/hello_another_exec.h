// -*- C++ -*-
/**
 * @file    hello_another_exec.h
 * @author  Martin Corino
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
#ifndef __RIDL_HELLO_ANOTHER_EXEC_H_JFIDJAIC_INCLUDED__
#define __RIDL_HELLO_ANOTHER_EXEC_H_JFIDJAIC_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : hello_another_impl.h[Header]

#pragma once

#include "hello_anotherEC.h"

#include /**/ "hello_another_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_another_impl.h[user_includes]
// Your includes here
//@@{__RIDL_REGEN_MARKER__} - END : hello_another_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_another_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : hello_another_impl.h[user_global_decl]
...
extern "C" HELLO_ANOTHER_EXEC_Export  void
create_Hello_Sender_Impl (
  IDL::traits<Components::EnterpriseComponent>::ref_type& component);
//@@{__RIDL_REGEN_MARKER__} - END : Hello_Sender_Impl[factory]
//@@{__RIDL_REGEN_MARKER__} - BEGIN : hello_another_impl.h[Footer]

#endif /* __RIDL_HELLO_ANOTHER_EXEC_H_JFIDJAIC_INCLUDED__ */
