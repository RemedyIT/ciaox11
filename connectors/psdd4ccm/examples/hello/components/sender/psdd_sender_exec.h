 ...
 */
#ifndef __RIDL_PSDD_SENDER_EXEC_H_JCIADJEC_INCLUDED__
#define __RIDL_PSDD_SENDER_EXEC_H_JCIADJEC_INCLUDED__
...
namespace Test_Sender_Impl
{
  ...
  private:
    ...
    IDL::traits<CCM_TT::TT_Timer>::ref_type tm_hello_;
    IDL::traits<CCM_TT::TT_Timer>::ref_type tm_msg_;
    uint32_t hello_counter_ {};
...
#endif /* __RIDL_PSDD_SENDER_EXEC_H_JCIADJEC_INCLUDED__ */
