// -*- C++ -*-
/**
 * @file    qa_sl_receiver_exec.h
 * @author  Marcel Smit
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */

#ifndef __RIDL_QA_SL_RECEIVER_EXEC_H_HFHAJDJA_INCLUDED__
#define __RIDL_QA_SL_RECEIVER_EXEC_H_HFHAJDJA_INCLUDED__

//@@{__RIDL_REGEN_MARKER__} - HEADER_END : qa_sl_receiver_impl.h[Header]

#pragma once

#include "qa_sl_receiverEC.h"

#include /**/ "receiver_exec_export.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_sl_receiver_impl.h[user_includes]
#include <atomic>
//@@{__RIDL_REGEN_MARKER__} - END : qa_sl_receiver_impl.h[user_includes]

//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_sl_receiver_impl.h[user_global_decl]
// Your declarations here
//@@{__RIDL_REGEN_MARKER__} - END : qa_sl_receiver_impl.h[user_global_decl]

/// Namespace for implementation of QA_State_Listen_Test::Receiver component
namespace QA_State_Listen_Test_Receiver_Impl
{
  /// Forward declarations
  class Receiver_exec_i;

  //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl[user_namespace_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl[user_namespace_decl]
  ...
  private:
    ...
    IDL::traits< ::QA_State_Listen_Test::CCM_Receiver_Context>::ref_type context_;

    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_members]
    std::atomic_ullong &created_;
    std::atomic_ullong &updated_;
    std::atomic_ullong &deleted_;
    //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl::listen_port_1_data_listener_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl::listen_port_1_status_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_members]
    std::atomic_ullong &created_;
    std::atomic_ullong &updated_;
    std::atomic_ullong &deleted_;
    //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl::listen_port_2_data_listener_exec_i[user_members]
    //@}
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_members]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl::listen_port_2_status_exec_i[user_members]
    //@}
  ...
  class Receiver_exec_i final
    : public virtual IDL::traits< ::QA_State_Listen_Test::CCM_Receiver>::base_type
  {
  public:
  ...
  private:
    ...
    /** @name User defined members. */
    //@{
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl::Receiver_exec_i[user_members]
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl::Receiver_exec_i[user_members]
    //@}
  ...
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : QA_State_Listen_Test_Receiver_Impl[user_namespace_end_decl]
  //@@{__RIDL_REGEN_MARKER__} - END : QA_State_Listen_Test_Receiver_Impl[user_namespace_end_decl]
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : qa_sl_receiver_impl.h[Footer]

#endif /* __RIDL_QA_SL_RECEIVER_EXEC_H_HFHAJDJA_INCLUDED__ */
