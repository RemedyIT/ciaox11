...
#endif /* TAOX11_AS_STATIC_LIBS && CIAOX11_EXF_AMH_HAS_DLL */
...
#    define CIAOX11_EXF_AMH_Export TAOX11_Proper_Export_Flag
#    define CIAOX11_EXF_AMH_SINGLETON_DECLARATION(T) TAOX11_EXPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_AMH_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* CIAOX11_EXF_AMH_BUILD_DLL */
#    define CIAOX11_EXF_AMH_Export TAOX11_Proper_Import_Flag
#    define CIAOX11_EXF_AMH_SINGLETON_DECLARATION(T) TAOX11_IMPORT_SINGLETON_DECLARATION (T)
#    define CIAOX11_EXF_AMH_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
